...
export default function Portfolio() {
  ...
  useEffect(() => {
    ...
    const scrollSpeed = 0.5; // Slower, more elegant speed
  ...
  // Your 6 local images from assets folder
      ...
      <nav className="portfolio-nav">
        ...
        <div className="social-icons">
          ...
          <a href="#" className="social-link">
            ...
            <a href="https://wa.me/919876543210" className="social-link"><FaWhatsapp size={16} /></a>
          {/* <a href="#" className="social-link">
            <svg className="icon" fill="currentColor" viewBox="0 0 24 24">
      ...
      <div className="name-overlay">
        <div className="name-container">
          <h1 className="name-title">
            <span className="name-first">BLACK</span>
            <span className="name-last">BOX</span>
          </h1>
        </div>
      </div>
